...
<div class="card">
    ...
    <h3 class="card-title"><a href="{{route('admins.create')}}" class="btn btn-outline-primary">{{trans('buttons_trans.create')}}</a></h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
    <table id="example1" class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <a href="{{route('showadmins',$user->id)}}" class="btn btn-sm btn-outline-success">userdetails</a>
                <a href="{{route('admins.edit',$user->id)}}" class="btn btn-sm btn-outline-primary">edit</a>
